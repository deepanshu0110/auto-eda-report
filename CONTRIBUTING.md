# Contributing to Auto EDA Report Generator
...
2. **Clone** your fork: `git clone https://github.com/<your-username>/auto-eda-report.git`
...
Streamlit app that generates instant EDA reports from any CSV.
